...
> actual vive en `docs/alcance_iteracion_uno.md`.
...
Cada intento de login, exitoso o fallido, debe quedar registrado en la tabla `auth.login` antes de responder al frontend .
