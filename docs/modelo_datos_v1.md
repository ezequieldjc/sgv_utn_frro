...
- **debe_cambiar**: boolean, Obligatorio. *Default: True*. (Cambio de clave en próximo login
  — el campo existe desde esta iteración; el enforcement en login (bloqueo hasta cambiar
  clave) está documentado en `docs/login.md` y `docs/alcance_iteracion_uno.md`).
