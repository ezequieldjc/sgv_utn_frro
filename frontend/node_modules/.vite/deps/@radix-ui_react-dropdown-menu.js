...
import {
  ...
  Root2,
  createPopperScope
} from "./chunk-PUWHLCZK.js";
import {
  Combination_default,
  FocusScope,
  hideOthers,
  useFocusGuards
} from "./chunk-BSSLMY6G.js";
import {
  DismissableLayer,
  Portal
} from "./chunk-RMOFLLZT.js";
import {
  useId
} from "./chunk-3VECHCGK.js";
import {
  useCallbackRef
} from "./chunk-LGJEOL5N.js";
import "./chunk-YLUNS5DV.js";
import {
  Presence,
  composeEventHandlers,
  useControllableState
} from "./chunk-33RKEX4V.js";
import {
  createContextScope,
  useLayoutEffect2
} from "./chunk-VUZR2QYK.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-K6NN2VIJ.js";
import {
  createSlot,
  useComposedRefs
...
var Menu = __name5((props) => {
  ...
  const direction = useDirection(dir);
  React6.useEffect(() => {
    const handleKeyDown = __name5(() => {
      isUsingKeyboardRef.current = true;
      document.addEventListener("pointerdown", handlePointer, { capture: true, once: true });
      document.addEventListener("pointermove", handlePointer, { capture: true, once: true });
    }, "handleKeyDown");
    const handlePointer = __name5(() => isUsingKeyboardRef.current = false, "handlePointer");
  ...
  React6.useEffect(() => {
    ...
    const handleBlur = __name5(() => handleOpenChange(false), "handleBlur");
...
var MenuAnchor = React6.forwardRef(
  __name5(function MenuAnchor2(props, forwardedRef) {
...
var MenuContent = React6.forwardRef(
  __name5(function MenuContent2(props, forwardedRef) {
...
var MenuRootContentModal = React6.forwardRef(
  // blank line to reduce diff noise
  __name5(function MenuRootContentModal2(props, forwardedRef) {
    const context = useMenuContext(CONTENT_NAME, props.__scopeMenu);
...
var MenuRootContentNonModal = React6.forwardRef(__name5(function MenuRootContentNonModal2(props, forwardedRef) {
  const context = useMenuContext(CONTENT_NAME, props.__scopeMenu);
  return (0, import_jsx_runtime5.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React6.forwardRef(
  // blank line to reduce diff noise
  __name5(function MenuContentImpl2(props, forwardedRef) {
    const {
      __scopeMenu,
      loop = false,
      trapFocus,
    ...
    const handleTypeaheadSearch = __name5((key) => {
      var _a2, _b;
...
var MenuGroup = React6.forwardRef(
  __name5(function MenuGroup2(props, forwardedRef) {
...
var MenuLabel = React6.forwardRef(
  __name5(function MenuLabel2(props, forwardedRef) {
...
var MenuItem = React6.forwardRef(
  // blank line to reduce diff noise
  __name5(function MenuItem2(props, forwardedRef) {
...
var MenuItemImpl = React6.forwardRef(
  __name5(function MenuItemImpl2(props, forwardedRef) {
...
var MenuCheckboxItem = React6.forwardRef(
  // blank line to reduce diff noise
  __name5(function MenuCheckboxItem2(props, forwardedRef) {
...
var [RadioGroupProvider, useRadioGroupContext] = createMenuContext(
  RADIO_GROUP_NAME,
  { value: void 0, onValueChange: __name5(() => {
  }, "onValueChange") }
);
var MenuRadioGroup = React6.forwardRef(
  __name5(function MenuRadioGroup2(props, forwardedRef) {
...
var MenuRadioItem = React6.forwardRef(
  __name5(function MenuRadioItem2(props, forwardedRef) {
...
var MenuItemIndicator = React6.forwardRef(
  // blank line to reduce diff noise
  __name5(function MenuItemIndicator2(props, forwardedRef) {
...
var MenuSeparator = React6.forwardRef(
  __name5(function MenuSeparator2(props, forwardedRef) {
...
var MenuArrow = React6.forwardRef(
  __name5(function MenuArrow2(props, forwardedRef) {
...
var MenuSubTrigger = React6.forwardRef(
  __name5(function MenuSubTrigger2(props, forwardedRef) {
...
var MenuSubContent = React6.forwardRef(
  __name5(function MenuSubContent2(props, forwardedRef) {
    const portalContext = usePortalContext(CONTENT_NAME, props.__scopeMenu);
...
__name5(getOpenState, "getOpenState");
function isIndeterminate(checked) {
  return checked === "indeterminate";
}
__name5(isIndeterminate, "isIndeterminate");
function getCheckedState(checked) {
  return isIndeterminate(checked) ? "indeterminate" : checked ? "checked" : "unchecked";
}
__name5(getCheckedState, "getCheckedState");
...
__name5(getNextMatch, "getNextMatch");
...
__name5(isPointerInGraceArea, "isPointerInGraceArea");
function whenMouse(handler) {
  return (event) => event.pointerType === "mouse" ? handler(event) : void 0;
}
__name5(whenMouse, "whenMouse");
var Root3 = Menu;
...
var DropdownMenu = __name6((props) => {
  const {
    __scopeDropdownMenu,
    children,
    dir,
...
var DropdownMenuTrigger = React7.forwardRef(
  // blank line to reduce diff noise
  __name6(function DropdownMenuTrigger2(props, forwardedRef) {
...
var DropdownMenuPortal = __name6((props) => {
...
var DropdownMenuContent = React7.forwardRef(
  // blank line to reduce diff noise
  __name6(function DropdownMenuContent2(props, forwardedRef) {
...
var DropdownMenuGroup = React7.forwardRef(
  // blank line to reduce diff noise
  __name6(function DropdownMenuGroup2(props, forwardedRef) {
...
var DropdownMenuLabel = React7.forwardRef(
  // blank line to reduce diff noise
  __name6(function DropdownMenuLabel2(props, forwardedRef) {
...
var DropdownMenuItem = React7.forwardRef(
  // blank line to reduce diff noise
  __name6(function DropdownMenuItem2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...itemProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime6.jsx)(Item2, { ...menuScope, ...itemProps, ref: forwardedRef });
  }, "DropdownMenuItem")
);
var DropdownMenuCheckboxItem = React7.forwardRef(__name6(function DropdownMenuCheckboxItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime6.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
}, "DropdownMenuCheckboxItem"));
var DropdownMenuRadioGroup = React7.forwardRef(__name6(function DropdownMenuRadioGroup2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime6.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
}, "DropdownMenuRadioGroup"));
var DropdownMenuRadioItem = React7.forwardRef(__name6(function DropdownMenuRadioItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime6.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
}, "DropdownMenuRadioItem"));
var DropdownMenuItemIndicator = React7.forwardRef(__name6(function DropdownMenuItemIndicator2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime6.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
}, "DropdownMenuItemIndicator"));
var DropdownMenuSeparator = React7.forwardRef(__name6(function DropdownMenuSeparator2(props, forwardedRef) {
...
var DropdownMenuArrow = React7.forwardRef(
  // blank line to reduce diff noise
  __name6(function DropdownMenuArrow2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...arrowProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime6.jsx)(Arrow2, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }, "DropdownMenuArrow")
);
var DropdownMenuSub = __name6((props) => {
...
var DropdownMenuSubTrigger = React7.forwardRef(__name6(function DropdownMenuSubTrigger2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...subTriggerProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime6.jsx)(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
}, "DropdownMenuSubTrigger"));
var DropdownMenuSubContent = React7.forwardRef(__name6(function DropdownMenuSubContent2(props, forwardedRef) {
